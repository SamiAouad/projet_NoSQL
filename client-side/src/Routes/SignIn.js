                    ...
                    <div className={style.content2}>
                        ...
                        <Form className='col-centered' onSubmit={formik.handleSubmit}>
                            ...
                            <Form.Group className="mb-3" controlId="formBasicPassword">
                                ...
                                <Form.Control name={'password'} onChange={formik.handleChange} value={formik.values.password}
                            ...
                            <div className='my-3'>
                                <span>Don't Have an account ? <a href='#' className=' text-white btn btn-outline-primary'> Register </a></span>
                            </div>
